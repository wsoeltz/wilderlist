...
export default (input: TemplateInput) => {
  ...
  <div style="max-width: 450px; margin: auto;font-family: Arial, sans-serif; line-height: 1.4;color: #333333;">
    <div style="text-align: center">
      <img style="max-width: 250px; display:inline-block;" src="https://wilderlist-dev.herokuapp.com/wilderlist-logo.png" />
    </div>
    ...
    <img style="max-width: 100%; margin-top: 60px;" src="https://wilderlist-dev.herokuapp.com/mountain-range.png" />
