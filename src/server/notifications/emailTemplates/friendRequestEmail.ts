...
export default (input: TemplateInput) => {
  ...
  <div style="max-width: 450px; margin: auto;font-family: Arial, sans-serif; line-height: 1.4;color: #333333;">
    ...
    <h1 style="text-align: center;font-size: 28px;">You have a friend request</h1>
    <p style="font-size: 17px;line-height: 1.7;">${userName} has sent you a friend request on Wilderlist.</p>
    <div style="text-align: center;">
