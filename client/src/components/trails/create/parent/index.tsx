...
import {
  useEditParentTrail,
  Variables,
} from '../../../../queries/trails/editTrailParent';
import {useTrailSegmentsWithStates} from '../../../../queries/trails/useTrailSegmentsWithStates';
...
const TrailCreatePage = () => {
  ...
  const {loading, error, data} = useTrailSegmentsWithStates(id ? id : null );
  const editTrail = useEditParentTrail();
