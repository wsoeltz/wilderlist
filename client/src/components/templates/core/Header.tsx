...
const Header = (props: RouteComponentProps) => {
  ...
  const createLink = (route: string, label: string, icon: FaProps['icon']) => {
    ...
    const className = route === Routes.Map ? 'header-dashboard-link' : undefined;
      ...
      <>
        <HeaderContainer>
          <SemanticLogoContainer>
            <LogoContainer to={Routes.Map}>
              {getString('global-text-value-wilderlist-name')}
              <Logo />
            </LogoContainer>
          </SemanticLogoContainer>
          <MainNav>
            {createLink(Routes.Map, getString('header-text-menu-item-dashboard'), faHome)}
